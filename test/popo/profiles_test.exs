defmodule Popo.ProfilesTest do
  use Popo.DataCase
  ...
  describe "profiles" do
    ...
    @valid_attrs %{dob: ~D[2010-04-17], gender: "some gender", intro: "some intro", photo: "some photo"}
    ...
    test "create_profile/1 with valid data creates a profile" do
      ...
      assert profile.intro == "some intro"
    ...
    test "update_profile/2 with valid data updates the profile" do
      ...
      assert profile.intro == "some updated intro"
